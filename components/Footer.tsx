...
export default function Footer() {
  return (
    <footer className="mt-20 pt-16 pb-8 px-6 bg-[#2C1506] text-[#F5EDDA]">
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-12 border-b border-white/10 pb-12">
        <div className="md:col-span-2">
          ...
          <p className="text-[#F5EDDA]/70 max-w-sm italic font-serif">
            {siteConfig.description}
          </p>
        </div>
        <div>
          <h4 className="font-bold mb-4">Quick Links</h4>
          <ul className="space-y-2 text-sm text-[#F5EDDA]/70">
      ...
      <div className="max-w-7xl mx-auto text-center text-sm text-[#F5EDDA]/50">
