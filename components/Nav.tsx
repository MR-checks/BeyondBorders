      ...
      <AnimatePresence>
        ...
        {isOpen && (
          <motion.div
            ...
            transition={{ duration: 0.2 }}
            className="md:hidden absolute top-20 left-0 w-full overflow-hidden bg-[#F5EDDA]/90 dark:bg-[#2E1408]/90 backdrop-blur-md shadow-lg border-t border-glass-border/10 z-50"
          >
