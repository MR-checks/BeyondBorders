export const processSteps = [
  {
    ...
    description: "Tell us your goals, lifestyle, business, travel history and academic background (if any)."
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: "With our expert guidance we've achieved a 100% visa success rate. From application to interview coaching and every pre-departure step, we make sure you feel confident, prepared, and ready."
  }
];
